...
setting = {
    "est_param" : ("inventory_adjustment_time", "wip_adjustment_time"),
    ...
    "model_name": "Inven_2adj_time_est_dot5_pnoise"
}
...
draws2data2draws('vensim_models/inventory/inventory.mdl', setting, numeric, prior, S, M, N, R)
