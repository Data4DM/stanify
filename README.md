...
|                         |`model.set_numeric()`                   |      assume `driving data` is numeric vector                                                                     |                                                     |                                                                                                                                        |
|                         | `model.update_numeric()` |                              |assume `assumed_parameter`, assume `driving data` numeric vector                                                    |express difference between generator and estimator                                                                                                                                        |
| model assumption        |                          |                                                                          |                                                     |                                                                                                                                        |
