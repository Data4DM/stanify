...
|                         | `model.update_numeric()`            |                                                                          | assign numeric scalar to `assumed_parameter`, assign numeric vector to `driving data` | express difference between generator and estimator e.g. `process_noise_scale`                                                                                                        |
| model assumption        |                                     |                                                                          |                                                                                       |                                                                                                                                                            |
...
|                         | `M`                                 | # of draws from posterior (# of chains * # of draws from each chain)     | # of MCMC samples                                                                     | 4 * 100                                                                                                                                                    |
...
|                         | `Q`                                 | # of `target_simulated_stock`                                            | # of vectors included in `.vpd` payoff function                                       | 2 (prey, predator)                                                                                                                                         |
|                         | `R`***                              | # of subgroup for hierarchical Bayes                                     | subscript range                                                                       | 2 region: R1, R2                                                                                                                                           |
|  noise settings                       |                                     |                                                                          |                                                                                       |                                                                                                                                                            |
