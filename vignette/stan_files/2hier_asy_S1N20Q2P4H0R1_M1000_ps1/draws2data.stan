...
generated quantities{
    real adj_mat_push_frac2 = normal_rng(0.125, 0.0125);
    real ss2p_frac4 = normal_rng(0.2, 0.020000000000000004);
    real m_noise_scale = normal_rng(10.0, 1.0);
    real adj_mat_push_frac1 = normal_rng(0.25, 0.025);
    ...
    vector[7] integrated_result[N] = ode_rk45(vensim_ode_func, initial_outcome, initial_time, integration_times, adj_mat_pull_frac3, ss2p_frac4, adj_mat_push_frac2, time_saveper, process_noise_scale, adj_mat_push_frac1);
    ...
    array [N] real stocked_pping_obs = normal_rng(stocked_pping, m_noise_scale);
    array [N] real stocked_ping_obs = normal_rng(stocked_ping, m_noise_scale);
}
