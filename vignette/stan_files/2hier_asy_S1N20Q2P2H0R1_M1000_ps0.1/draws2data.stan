...
generated quantities{
    ...
    vector[7] integrated_result[N] = ode_rk45(vensim_ode_func, initial_outcome, initial_time, integration_times, adj_mat_push_frac1, adj_mat_push_frac2, process_noise_scale, time_saveper);
