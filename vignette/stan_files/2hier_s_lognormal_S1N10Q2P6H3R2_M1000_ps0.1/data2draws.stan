...
transformed parameters {
    ...
    for (r in 1:R){
        array[N] vector[5] integrated_result = ode_rk45(vensim_ode_func, initial_outcome, initial_time, integration_times, adj_frac3[r], process_noise_scale, time_saveper, adj_frac1[r], adj_frac2[r]);
