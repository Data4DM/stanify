...
data{
    ...
    vector[30] exog_demand;
    vector[30] process_noise_normal_driving;
...
transformed parameters {
    ...
    for (r in 1:R){
        array[N] vector[5] integrated_result = ode_rk45(vensim_ode_func, initial_outcome, initial_time, integration_times, adj_frac2[r], time_saveper, adj_frac1[r], process_noise_scale);
