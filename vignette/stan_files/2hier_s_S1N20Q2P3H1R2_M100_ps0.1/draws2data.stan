...
generated quantities{
    ...
    for (r in 1:R){
        array[N] vector[5] integrated_result = ode_rk45(vensim_ode_func, initial_outcome, initial_time, integration_times, time_saveper, adj_frac2, process_noise_scale, adj_frac1[r]);
