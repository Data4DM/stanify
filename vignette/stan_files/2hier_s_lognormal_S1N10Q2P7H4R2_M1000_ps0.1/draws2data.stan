...
generated quantities{
    ...
    real adj_frac3_loc = normal_rng(0.5, 0.05);
    real adj_frac3[R] =  normal_rng(rep_vector(adj_frac3_loc, R), 0.05);
    real adj_frac1[R] =  normal_rng(rep_vector(adj_frac1_loc, R), 0.025);
    real adj_frac2_loc = normal_rng(0.125, 0.0125);
    real adj_frac2[R] =  normal_rng(rep_vector(adj_frac2_loc, R), 0.0125);
    real m_noise_scale = lognormal_rng(0.0, 1);
    real ss2p_frac4_loc = normal_rng(0.2, 0.020000000000000004);
    real ss2p_frac4[R] =  normal_rng(rep_vector(ss2p_frac4_loc, R), 0.020000000000000004);
