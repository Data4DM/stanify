...
transformed parameters {
    ...
    for (r in 1:R){
        array[N] vector[6] integrated_result = ode_rk45(vensim_ode_func, initial_outcome, initial_time, integration_times, wip_adjustment_time, inventory_adjustment_time[r], time_step);
...
model{
    ...
    inventory_adjustment_time ~ normal(rep_vector(8.0, R), 0.8);
    for (r in 1:R)
