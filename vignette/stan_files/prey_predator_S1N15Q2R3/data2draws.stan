...
data{
    ...
    vector[15] process_noise_uniform_driving;
...
parameters{
    ...
    array[R] real<lower=0> prey_birth_frac;
...
transformed parameters {
    ...
    for (r in 1:R){
        array[N] vector[3] integrated_result = ode_rk45(vensim_ode_func, initial_outcome, initial_time, integration_times, process_noise_scale, time_step, prey_birth_frac[r], pred_birth_frac);
...
model{
    ...
    prey_birth_frac ~ normal(rep_vector(0.8, R), 0.08);
