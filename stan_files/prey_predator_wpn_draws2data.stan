functions{
#include prey_predator_wpn_functions.stan
}
data{
    int n_t;
...
generated quantities{
    ...
    vector[3] integrated_result[n_t] = ode_rk45(vensim_ode_func, initial_outcome, initial_time, times, alpha, beta, delta, gamma);
