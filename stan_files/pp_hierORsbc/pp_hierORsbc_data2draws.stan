...
parameters{
    ...
    array[n_r] real<lower=0> pred_birth_frac;
...
model{
    ...
    pred_birth_frac ~ normal(rep_vector(0.05, n_r), 0.005);
...
generated quantities{
    real loglik;
    array[n_t] vector[n_r] prey_obs_posterior;
    array[n_t] vector[n_r] predator_obs_posterior;
    for (r in 1:n_r){
