functions{
    #include Inven_6est_functions.stan
}
...
transformed parameters {
    ...
    vector[7] integrated_result[n_t] = ode_rk45(vensim_ode_func, initial_outcome, initial_time, times, wip_adjustment_time, manufacturing_cycle_time, safety_stock_coverage, inventory_adjustment_time, target_delivery_delay, process_noise_scale, minimum_order_processing_time, time_step);
