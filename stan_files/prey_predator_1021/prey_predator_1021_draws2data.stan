functions{
#include prey_predator_1021_functions.stan
}
data{
    int n_t;
    real time_step;
...
generated quantities{
    ...
    vector[3] integrated_result[n_t] = ode_rk45(vensim_ode_func, initial_outcome, initial_time, times, process_noise_scale, alpha, beta, time_step, delta, gamma);
