functions{
#include Inven_2est_functions.stan
}
data{
    int n_t;
    int n_r;
...
generated quantities{
    ...
    vector[7] integrated_result[n_t] = ode_rk45(vensim_ode_func, initial_outcome, initial_time, times, minimum_order_processing_time, time_step, inventory_adjustment_time, process_noise_scale);
