functions{
    #include prey_predator_normal_functions.stan
}
...
transformed parameters {
    ...
    vector[3] integrated_result[n_t] = ode_rk45(vensim_ode_func, initial_outcome, initial_time, times, process_noise_scale, beta, gamma, delta, time_step, alpha);
