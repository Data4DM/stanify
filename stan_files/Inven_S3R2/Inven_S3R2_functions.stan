...
real dataFunc__process_noise_uniform_driving(real time, real time_step){
    ...
    if(time <= time_step * 1){
        intercept = -0.21737406698340367;
        real local_time_step = time_step * 1 - time_step * 0;
        slope = (0.3269662388585606 - -0.21737406698340367) / local_time_step;
        return intercept + slope * (time - time_step * 0);
    }
    else if(time <= time_step * 2){
        intercept = 0.3269662388585606;
        real local_time_step = time_step * 2 - time_step * 1;
        slope = (-0.46436648508649236 - 0.3269662388585606) / local_time_step;
        return intercept + slope * (time - time_step * 1);
    }
    else if(time <= time_step * 3){
        intercept = -0.46436648508649236;
        real local_time_step = time_step * 3 - time_step * 2;
        slope = (0.18990196486854027 - -0.46436648508649236) / local_time_step;
        return intercept + slope * (time - time_step * 2);
    }
    else if(time <= time_step * 4){
        intercept = 0.18990196486854027;
        real local_time_step = time_step * 4 - time_step * 3;
        slope = (-0.49919034106844695 - 0.18990196486854027) / local_time_step;
        return intercept + slope * (time - time_step * 3);
    }
    else if(time <= time_step * 5){
        intercept = -0.49919034106844695;
        real local_time_step = time_step * 5 - time_step * 4;
        slope = (0.33218147201532 - -0.49919034106844695) / local_time_step;
        return intercept + slope * (time - time_step * 4);
    }
    else if(time <= time_step * 6){
        intercept = 0.33218147201532;
        real local_time_step = time_step * 6 - time_step * 5;
        slope = (-0.006842155082863566 - 0.33218147201532) / local_time_step;
        return intercept + slope * (time - time_step * 5);
    }
    else if(time <= time_step * 7){
        intercept = -0.006842155082863566;
        real local_time_step = time_step * 7 - time_step * 6;
        slope = (-0.0987775361365889 - -0.006842155082863566) / local_time_step;
        return intercept + slope * (time - time_step * 6);
    }
    else if(time <= time_step * 8){
        intercept = -0.0987775361365889;
        real local_time_step = time_step * 8 - time_step * 7;
        slope = (0.31379697762392866 - -0.0987775361365889) / local_time_step;
        return intercept + slope * (time - time_step * 7);
    }
    else if(time <= time_step * 9){
        intercept = 0.31379697762392866;
        real local_time_step = time_step * 9 - time_step * 8;
        slope = (-0.14091332651064825 - 0.31379697762392866) / local_time_step;
        return intercept + slope * (time - time_step * 8);
    }
    else if(time <= time_step * 10){
        intercept = -0.14091332651064825;
        real local_time_step = time_step * 10 - time_step * 9;
        slope = (-0.05950474168664932 - -0.14091332651064825) / local_time_step;
        return intercept + slope * (time - time_step * 9);
    }
    else if(time <= time_step * 11){
        intercept = -0.05950474168664932;
        real local_time_step = time_step * 11 - time_step * 10;
        slope = (0.01619331583961503 - -0.05950474168664932) / local_time_step;
        return intercept + slope * (time - time_step * 10);
    }
    else if(time <= time_step * 12){
        intercept = 0.01619331583961503;
        real local_time_step = time_step * 12 - time_step * 11;
        slope = (0.34464185789561774 - 0.01619331583961503) / local_time_step;
        return intercept + slope * (time - time_step * 11);
    }
    else if(time <= time_step * 13){
        intercept = 0.34464185789561774;
        real local_time_step = time_step * 13 - time_step * 12;
        slope = (-0.4300688123041243 - 0.34464185789561774) / local_time_step;
        return intercept + slope * (time - time_step * 12);
    }
    else if(time <= time_step * 14){
        intercept = -0.4300688123041243;
        real local_time_step = time_step * 14 - time_step * 13;
        slope = (0.3145462070816314 - -0.4300688123041243) / local_time_step;
        return intercept + slope * (time - time_step * 13);
    }
    else if(time <= time_step * 15){
        intercept = 0.3145462070816314;
        real local_time_step = time_step * 15 - time_step * 14;
        slope = (0.09494083626057048 - 0.3145462070816314) / local_time_step;
        return intercept + slope * (time - time_step * 14);
    }
    else if(time <= time_step * 16){
        intercept = 0.09494083626057048;
        real local_time_step = time_step * 16 - time_step * 15;
        slope = (-0.04640225048105984 - 0.09494083626057048) / local_time_step;
        return intercept + slope * (time - time_step * 15);
    }
    else if(time <= time_step * 17){
        intercept = -0.04640225048105984;
        real local_time_step = time_step * 17 - time_step * 16;
        slope = (-0.0224344578096628 - -0.04640225048105984) / local_time_step;
        return intercept + slope * (time - time_step * 16);
    }
    else if(time <= time_step * 18){
        intercept = -0.0224344578096628;
        real local_time_step = time_step * 18 - time_step * 17;
        slope = (-0.36563905791797546 - -0.0224344578096628) / local_time_step;
        return intercept + slope * (time - time_step * 17);
    }
    else if(time <= time_step * 19){
        intercept = -0.36563905791797546;
        real local_time_step = time_step * 19 - time_step * 18;
        slope = (-0.2567196873741846 - -0.36563905791797546) / local_time_step;
        return intercept + slope * (time - time_step * 18);
    }
    return -0.2567196873741846;
}
